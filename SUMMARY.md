...
* [C# Fundamentals](csharp/)
  ...
  * [4. Delegates, Events & Lambdas](csharp/guide4-delegates-events-lambdas.md)
  * [5. Advanced Features Timeline](csharp/guide5-advanced-features-timeline.md)
  * [6. Exception Handling](csharp/guide6-exception-handling.md)
  * [7. LINQ](csharp/guide7-linq.md)
  * [8. DateTime, Regex & Utilities](csharp/guide8-datetime-regex-utilities.md)
  * [9. Namespaces & Assemblies](csharp/guide9-namespaces-assemblies-organization.md)
  * [10. .NET Runtime & Core Concepts](csharp/guide10-dotnet-runtime-core-concepts.md)
  * [11. File I/O Quick Reference](csharp/guide11-Csharp-File-io-Quick-Reference.md)
...
* [ASP.NET Core](aspnetcore/)
  ...
  * [3. Middleware & HTTP Pipeline](aspnetcore/guide3-Middleware-HTTP-Pipeline.md)
  * [4. Routing & Controllers](aspnetcore/guide4-routing-controllers-guide.md)
  * [5. Entity Framework Core](aspnetcore/guide5-EntityFrameworkCore.md)
  * [6. REST API, DTO & Validation](aspnetcore/guide6-REST-API-DTO-Validation.md)
  * [7. Authentication & Authorization](aspnetcore/guide7-Authentication-Authorization.md)
  * [8. Filters, Logging & Error Handling](aspnetcore/guide8-Filters-Logging-ErrorHandling.md)
  * [9. Testing ASP.NET Core](aspnetcore/guide9-Testing-ASP-NET-Core.md)
  * [10. Testing (Advanced)](aspnetcore/guide10-Testing-ASP.NET-Core.md)
  * [11. Common Interfaces & Namespaces](aspnetcore/guide11-Common-Interfaces-Namespaces.md)
...
* [Complete Workbook](workbook/)
  ...
  * [Setup Guide](workbook/01-setup-guide.md)
